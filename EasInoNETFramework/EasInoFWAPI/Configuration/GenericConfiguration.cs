...
namespace EasInoAPI.Configuration
{
    public class GenericConfiguration
    {
        ...
        internal GenericConfiguration Deserialize()
        {
            ...
            GenericConfiguration conf = JsonConvert.DeserializeObject<GenericConfiguration>(jsonString);
            ...
            {
                return JsonConvert.DeserializeObject<SerialComConfiguration>(jsonString);
            }
            else
            {
                return conf;
