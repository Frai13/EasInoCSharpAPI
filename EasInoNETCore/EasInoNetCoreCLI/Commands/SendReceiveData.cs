...
{
    internal class SendReceiveData : ICommand
    {
        public IEnumerable<string> Command => new List<string>() { "-sr", "--sendreceive" };
        ...
        public string Description => "Send data to EasIno board and wait to receive";
